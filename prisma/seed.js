...
async function main() {
  ...
  const inv3 = await prisma.invoice.create({
    data: {
      ...
      totalAmount: 3450,
      amountPaid: 0,
      reminderCount: 1, // Stage 1 (initial delivery sent)
  ...
  const inv4 = await prisma.invoice.create({
    data: {
      ...
      totalAmount: 2900,
      amountPaid: 0,
      reminderCount: 2, // Stage 2 (initial + 7-day reminder dispatched)
      ...
      activities: {
        create: [
          ...
          { type: 'reminder_sent', description: 'Automated 7-Day payment reminder sent to client (2/3 notifications)', createdAt: daysAgo(3) },
        ],
      },
    },
  });
